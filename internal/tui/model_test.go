...
func testModelWithClient(t *testing.T, client *mattermost.Client, teamID string) Model {
	t.Helper()
	m := NewModelWithHeader(HeaderInfo{}, "", nil, nil, nil, nil, client, teamID, 22, false, "15", "237", "", "root_only", 70, "alphabetical", false)
	updated, _ := m.Update(tea.WindowSizeMsg{Width: 80, Height: 24})
	return mustModel(t, updated)
}
...
func TestHelpPopupOpens(t *testing.T) {
	m := NewModelWithHeader(HeaderInfo{}, "", nil, nil, nil, nil, nil, "", 22, false, "15", "237", "", "root_only", 70, "alphabetical", false)
	m = initModel(t, m)
...
func TestMessagesViewShowAll(t *testing.T) {
	m := NewModelWithHeader(HeaderInfo{}, "", nil, nil, nil, nil, nil, "", 22, false, "15", "237", "", "all", 70, "alphabetical", false)
	m = initModel(t, m)
	m.activeChannelID = "chan1"
